...
<head>
    ...
    <title>touts les commentaires que vous avez écris</title>
</head>
<body>
...
<main>
   ...
   <div class="container column grey" align="center">
       <h2>Voici touts les commentaires que vous avez écris</h2>
       <!-- <br/><br/> -->
                    ...
                    <?php
                            if (isset($_SESSION['id_user'])) 
                            {
                                ...
                                echo '<div>
                                      ...
                                      <a href="liste_commentaire.php?id_souhait=' . $id_souhait . '">Afficher les commentaires</a>
                                      </div>';
                            } else 
                            {
                                echo 'CONNECTEZ-VOUS!';
